...
`ogc.ecrrProperties.ecrrCommon` *v0.1*
...
```jsonld
{
  "@context": [
    ...
    "https://usgin.github.io/ecrrBuildingBlocks/build/annotated/ecrrProperties/ecrrCommon/context.jsonld"
  ],
  "schema:identifier": "https://doi.org/10.5281/zenodo.4002870",
  "schema:version": "0.6.2",
  "schema:alternateName": "Python Package for the Analysis of Paleoclimate Data",
...
$defs:
  LabeledLink:
    $ref: https://usgin.github.io/metadataBuildingBlocks/_sources/schemaorgProperties/labeledLink/schema.yaml
  Identifier:
    $ref: https://usgin.github.io/metadataBuildingBlocks/_sources/schemaorgProperties/identifier/schema.yaml
  DefinedTerm:
  ...
  Funder:
    $ref: https://usgin.github.io/metadataBuildingBlocks/_sources/schemaorgProperties/funder/schema.yaml
...
* YAML version: [schema.yaml](https://usgin.github.io/ecrrBuildingBlocks/build/annotated/ecrrProperties/ecrrCommon/schema.json)
* JSON version: [schema.json](https://usgin.github.io/ecrrBuildingBlocks/build/annotated/ecrrProperties/ecrrCommon/schema.yaml)
...
[context.jsonld](https://usgin.github.io/ecrrBuildingBlocks/build/annotated/ecrrProperties/ecrrCommon/context.jsonld)
