...
`ogc.ecrrProperties.ecrrCatalog` *v0.1*
...
```jsonld
{
  "@context": [
    ...
    "https://usgin.github.io/ecrrBuildingBlocks/build/annotated/ecrrProperties/ecrrCatalog/context.jsonld"
  ],
  "schema:contentType": [
    {
      "@type": "schema:Thing",
...
* YAML version: [schema.yaml](https://usgin.github.io/ecrrBuildingBlocks/build/annotated/ecrrProperties/ecrrCatalog/schema.json)
* JSON version: [schema.json](https://usgin.github.io/ecrrBuildingBlocks/build/annotated/ecrrProperties/ecrrCatalog/schema.yaml)
...
[context.jsonld](https://usgin.github.io/ecrrBuildingBlocks/build/annotated/ecrrProperties/ecrrCatalog/context.jsonld)
