...
`ogc.ecrrProperties.ecrrCollection` *v0.1*
...
```jsonld
{
  "@context": [
    ...
    "https://usgin.github.io/ecrrBuildingBlocks/build/annotated/ecrrProperties/ecrrCollection/context.jsonld"
  ],
  "schema:hasPart": [
    {
      "@type": "schema:SoftwareApplication",
...
* YAML version: [schema.yaml](https://usgin.github.io/ecrrBuildingBlocks/build/annotated/ecrrProperties/ecrrCollection/schema.json)
* JSON version: [schema.json](https://usgin.github.io/ecrrBuildingBlocks/build/annotated/ecrrProperties/ecrrCollection/schema.yaml)
...
[context.jsonld](https://usgin.github.io/ecrrBuildingBlocks/build/annotated/ecrrProperties/ecrrCollection/context.jsonld)
